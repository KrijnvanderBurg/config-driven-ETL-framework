...
# from datastore.models.job.extract_spec import ExtractSpecAbstract
# from datastore.models.job.load_spec import LoadSpecAbstract
# from datastore.models.transform import TransformSpecAbstract
# from datastore.engine.bridge.pyspark.extract import ExtractContext
# from datastore.engine.bridge.pyspark.load import LoadContext
# from datastore.engine.bridge.pyspark.transform import TransformContext
...
#     def __init__(
#         self, extract_spec: ExtractSpecAbstract, transform_spec: TransformSpecAbstract, load_spec: LoadSpecAbstract
#     ):
#         """
...
#             Job: job instance.
#         """
#         extract_spec: ExtractSpecAbstract = ExtractSpecAbstract.from_dict(confeti=confeti["extract"])
#         transform_spec: TransformSpecAbstract = TransformSpecAbstract.from_dict(confeti=confeti["transform"])
#         load_spec: LoadSpecAbstract = LoadSpecAbstract.from_dict(confeti=confeti["load"])
