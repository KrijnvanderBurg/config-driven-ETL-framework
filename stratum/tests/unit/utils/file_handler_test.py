...
from stratum.utils.file_handler import FileHandler, FileHandlerContext, FileJsonHandler, FileYamlHandler
...
class TestFileHandler:
    ...
    def test__init(self) -> None:
        ...
        # Arrange
        strategy_mock = Mock(model=FileJsonHandler)
    ...
    def test__set_strategy(self) -> None:
        ...
        # Arrange
        json_handler_mock = Mock(model=FileJsonHandler)
        yaml_handler_mock = Mock(model=FileYamlHandler)
