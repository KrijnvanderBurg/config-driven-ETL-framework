...
#         Args:
#             columns (dict[str, Any]): Dictionary with column names as keys and target data types as values.
...
#     @classmethod
#     def select_with_alias(cls, columns: Ordereddict[str, Any]) -> Callable:
#         """
