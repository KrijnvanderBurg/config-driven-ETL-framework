...
from flint.etl.core.job import LOADS
from flint.etl.core.load import DATA_FORMAT, LOCATION, SCHEMA_LOCATION
...
def test_job_command(tmp_path: Path, job_path: str) -> None:
    ...
    # Step 2: Update the ETL configuration for temporary paths
    for job in data["etl"]:
    ...
    # Step 4: Overwrite the modified data to the existing JSON file
