...
## Isort
Import organizer of Pep8. Press <kbd>Alt</kbd>+<kbd>shift</kbd>+<kbd>O</kbd> to run for currently open file. 

The setting `"source.organizeImports": "explicit"` should make Isort run on file save, but does not work for unknown reasons.
